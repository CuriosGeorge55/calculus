...
\begin{exercise}
	...
	Let $R$ be the region in the $xy$-plane bounded by $y=0$, $y=\ln x$, $y=2$, and $x=1$. This exercise will walk you through setting up an integral using the Washer Method that will give the volume of the solid generated when $R$ is revolved about the line $x=-1$.
            \begin{image}
            \begin{tikzpicture}
            	\begin{axis}[
